		...
		try:
			...
			if location:
				...
				if latitude != "0.0" and longitude != "0.0":
					...
					link = """https://api.expertise97.hasura-app.io/api/update_trip?user_id={str1}&vehicle_id={str2}&latitude={str3}&longitude={str4}&timestamp={str5}""".format(str1=userdata["user_id"],
