...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String ufname=sharedPreferences.getString("user_firstname",null);
        String ulname=sharedPreferences.getString("user_lastname",null);

        Toast.makeText(getApplicationContext(), "Welcome: "+ufname+" "+ulname,
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if(position==0){
                ...
                VehicleFragment pollutionFragment= new VehicleFragment();
                return pollutionFragment;
            }
